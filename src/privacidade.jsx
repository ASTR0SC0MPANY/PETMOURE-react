...
<div className="informes-texto" id="seus-direitos">
    ...
    <div className="informes">
        ...
        <p class="numero" id="6.2">6.2 Exclusão de Conta: </p>
...
<div class="informes-texto" id="criancas">
    ...
    <div class="informes">
        ...
        <p class="numero" id="7.1">7.1 Crianças: </p>
...
<div class="informes-texto" id="alteracoes">
    ...
    <div class="informes">
        ...
        <p class="numero" id="8.1">8.1 Parceiros de Serviços: </p>
